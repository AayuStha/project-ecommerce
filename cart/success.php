...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO checkoutForm(email, contact, city, address, landmark, payment) VALUES (?, ?, ?, ?, ?, ?)");

    $stmt->bind_param("ssssss", $email, $contact, $city, $address, $landmark, $payment);

    if ($stmt->execute()) {
        echo '<h1 style="text-align: center; margin: 150px auto">Your order has been placed. Thank you!<h1>';
